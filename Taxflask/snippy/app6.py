...
class Application():
    def __init__(self, master):
        ...
        self.sku_label = Label(self.menu_frame, text="Enter SKU:")
        self.sku_label.pack()
        ...
        self.buttonBar.pack(fill=BOTH, expand=YES)  # Allow buttonBar to fill the space

        self.snipButton = Button(self.buttonBar, width=7, height=3,text='take snip', command=self.create_screen_canvas,)
